  ...
  update(state) {
    ...
    for(let i=0; i<=2; i++ ){
      for(let j=0; j<=2; j++ ){
        ...
        //onClick (400+(j-1.5)*fieldSize, 400+(i-1.5)*fieldSize, fieldSize, fieldSize, function () {alert(i*3+j)})
        //onClick (400+(j-1.5)*fieldSize, 400+(i-1.5)*fieldSize, fieldSize, fieldSize, function () {this.client.moves.clickCell(3*i+j)} )
    ...
    //alert(toString(this.client.endIf(endIf)))
    if(gameEnd==true){
